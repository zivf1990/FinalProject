        ...
        <div className="users">
            ...
            <table>
                ...
                {visibleUsers.map(user => (
                    <tr style={user.permission_level=="user"?{background:"green"}:{background:"red"}}>
                        <th>{user.user_id}</th>
                        <th>{user.username}</th>
                        <th>{user.email}</th>
                        <th>{user.address}</th>
                        <th id="permission_cell" onClick={()=>changePermission(user.user_id)}>{user.permission_level}</th>
